...
The `h` parameter is meant to be suggestive of 'hash', but we're actually parametric in the thing being edited and will assume as little about it as possible. (_Update:_ The representation of `opened` was tweaked slightly. [Older verion here](https://gist.github.com/pchiusano/e429df1827504ae50de3/0350fdd7fd9362a7368df2385bf2f54d26f1e2a8) for the curious.)
